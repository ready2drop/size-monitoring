...
The algorithm is elaborated on our paper[Link Text](https://github.com/ready2drop/Size-monitoring/Deep Learning-Based Pancreas Detection and Size Monitoring with Data Augmentation for Medical Imaging Analysis.pdf)
# Steps to run Code
